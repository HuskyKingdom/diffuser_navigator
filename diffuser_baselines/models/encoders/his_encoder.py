...
class HistoryGRU(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, num_layers=2):
        ...
        self.gru = nn.GRU(input_size, output_size, num_layers, batch_first=True)
    ...
    def forward(self, x, hiddens,lengths=None, inference=False):
        ...
        if not inference:
            ...
            output, _ = pad_packed_sequence(packed_output, batch_first=True) # (bs,seq,dim)

        else:
            output, hiddens = self.gru(x,hiddens)
