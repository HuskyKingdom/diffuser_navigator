...
def load(
    ...
    if os.path.isdir(model_id_or_path):
        ...
        print(f"Downloading `{(model_id := GLOBAL_REGISTRY[model_id_or_path]['model_id'])} from HF Hub")
    ...
    print(f"Loading Vision Backbone [bold]{model_cfg['vision_backbone_id']}[/]")
    ...
    print(f"Loading Pretrained LLM [bold]{model_cfg['llm_backbone_id']}[/] via HF Transformers")
    ...
    elif load_type == "baseline": 
        from diffuser_baselines.models.openvln_policy_baseline import OpenVLN
        vlm = OpenVLN.from_pretrained(
            checkpoint_pt,
            model_cfg["model_id"],
            vision_backbone,
